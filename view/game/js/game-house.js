var housegame = function () {
    ...
    this.luckpic = ["img/luck1.png","img/luck2.png","img/luck3.png","img/luck4.png"];//记录幸运事件图片
    ...
    this.init = function () {
        //创建地图 start
        for(var i = 0;i<80;i++){//生成地图
            var land=$("<div>",{"class":"game-lands","id":"land"+i,"belong":"none","special":false,"road":["land"+(i+16),"land"+(i-1),"land"+(i-16),"land"+(i+1)],"temporary":"none"});
            $(".game-content").append(land);
        }
        //添加获得金币的额外机会
        $("body").append("<div class='game-luck-shadow'> <div class='game-luck-content'> <img src=''> <div class='game-btn' style='margin-right:85px;margin-top:15px;' id='luckbtn'>确认</div> </div> </div>");
    ...
    this.goodluck = function(){
        ...
        if(num == 7){
            ...
            switch(money){
                case -1:
                 $(".game-luck-content img").attr("src",that.luckpic[0]);
                 break;
                case 0:
                 $(".game-luck-content img").attr("src",that.luckpic[1]);
                 break;
                case 1:
                 $(".game-luck-content img").attr("src",that.luckpic[2]);
                 break;
                case 2:
                 $(".game-luck-content img").attr("src",that.luckpic[3]);
                 break;
            }
        }
    }
