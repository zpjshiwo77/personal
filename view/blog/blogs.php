...
<head>
	...
	<link rel="stylesheet" type="text/css"  href="js/plugs/pager/pager.css">
			...
			<div class="blog-right">
				<div style="height:600px;width:900px;margin:60px 0 0 100px;" id="article">
					<div class="message-title">
						<div class="titile-word"><span class="icons" style="margin:13px 15px; background-position:-95px 0px;"></span><b>JAVASCRIPT</b></div>
					</div>
					<div class="myMessage">
						<table>
							<thead>
...
<script src="js/plugs/pager/pager.js"></script>
