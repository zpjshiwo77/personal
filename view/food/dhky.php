...
<head>
	...
	<meta name="keywords" content="豆花烤鱼">
	<meta name="description" content="豆花烤鱼">
		...
		<div class='food'>
			...
			<section class="step step01">
				...
				<div class="contentR">
					<div class="intro_word">
						<p>腌制鱼肉</p>
						<p>鱼肉洗净.</p>
						<p>把鱼肉刨开成两瓣，加入料酒、盐和胡椒腌制。</p>
						<p>腌制一个小时左右。</p>
						<p class="tips">tips:我选的是黑鱼，家乡那边用的是江团（鮰鱼）比较多，草鱼和鲢鱼也是不错的。</p>
					</div>
					<div class="intro_img">
						<img src="img/dhky/step_01.jpg">
					</div>
				</div>
			</section>
			<section class="show">
			...
			<section class="step step02">
				...
				<div class="contentL">
					<div class="intro_word">
						<p>烤鱼</p>
						<p>腌制完成后，给铁板和鱼刷上油。</p>
						<p>烤箱上下150度，中层烤25分钟左右。</p>
					</div>
					<div class="intro_img">
						<img src="img/dhky/step_02.jpg">
					</div>
				</div>
			</section>
			<section class="step step03">
				...
				<div class="contentR">
					<div class="intro_word">
						<p>备菜</p>
						<p>趁着烤鱼的这段时间可以备菜。</p>
						<p>土豆和黄瓜削皮切条，姜和洋葱切片，青椒大葱切段，大蒜拍好，香菜干辣椒洗净备用。</p>
					</div>
					<div class="intro_img">
						<img src="img/dhky/step_03.jpg">
					</div>
				</div>
			</section>
			<section class="step step04">
				...
				<div class="contentL">
					<div class="intro_word">
						<p>炒香料</p>
						<p>热锅冷油，放入大葱、蒜瓣、姜片、花椒和干辣椒大火炒香。</p>
					</div>
					<div class="intro_img">
						<img src="img/dhky/step_04.jpg">
					</div>
				</div>
			</section>
			<section class="step step05">
				...
				<div class="contentR">
					<div class="intro_word">
						<p>炒酱料</p>
						<p>接着加入豆瓣酱和青椒炒香。</p>
						<p>然后倒入一碗水，并把土豆和黄瓜倒入，再加入冰糖和适量的盐煮5分钟。</p>
					</div>
					<div class="intro_img">
						<img src="img/dhky/step_05.jpg">
					</div>
				</div>
			</section>
			<section class="step step06">
				...
				<div class="contentL">
					<div class="intro_word">
						<p>再次烤鱼</p>
						<p>鱼烤完后把煮好的酱料倒在鱼上，并加上豆花再次烤。</p>
						<p>上火150度，下火250度，下层烤十分钟。</p>
						<p class="tips">tips:考好的鱼记得翻一下，鱼肉朝上，这样才入味。</p>
					</div>
					<div class="intro_img">
						<img src="img/dhky/step_06.jpg">
					</div>
				</div>
			</section>
			<section class="step step07">
				...
				<div class="contentR">
					<div class="intro_word">
						<p>出锅</p>
						<p>烤好后，加上香菜装盘，一盘美味的豆花烤鱼就完成了。</p>
						<p class="tips">tips:有条件的，可以继续放在烤炉上小火烤，边烤边吃，还可以加入一些小菜~</p>
					</div>
					<div class="intro_img">
						<img src="img/dhky/step_07.jpg">
					</div>
				</div>
			</section>
		</div>
...
var m_material = [{name:"黑鱼",num:"1斤半"},{name:"豆花",num:"一碗"},{name:"土豆",num:"一个"},{name:"黄瓜",num:"半节"}];
var n_material = [{name:"豆瓣酱",num:"一大勺"},{name:"大葱",num:"若干"},{name:"姜",num:"少许"},{name:"蒜",num:"少许"},{name:"盐",num:"少许"},{name:"干辣椒",num:"适量"},{name:"料酒",num:"少量"},{name:"青椒",num:"2根"},{name:"花椒",num:"适量"},{name:"洋葱",num:"半个"},{name:"冰糖",num:"2颗"},{name:"香菜",num:"若干"}];
