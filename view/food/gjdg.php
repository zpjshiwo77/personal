...
<head>
	...
	<meta name="keywords" content="果酱蛋糕派">
	<meta name="description" content="果酱蛋糕派">
...
<body>
	...
	<div class="background">
		<div class='food'>
			<section class="main">
				<div class="intro">
					<img style="height:540px;width:720px;" src="img/gjdg/main.png">
					<div class="title">
						<h1>果酱蛋糕派</h1>
						<h2 class="ff-youyuan">Birthday Squish Cake Pie</h2>
					</div>
				</div>
			...
			<section class="step step01">
				...
				<div class="contentR">
					<div class="intro_word">
						<p>准备食材</p>
						<p class="tips">tips:所有材料最好用度量工具量好量。我用的是米缸。</p>
					</div>
					<div class="intro_img">
						<img src="img/gjdg/step_01.jpg">
					</div>
				</div>
			</section>
			<section class="show">
			...
			<section class="step step02">
				...
				<div class="contentL">
					<div class="intro_word">
						<p>分离蛋黄，蛋清</p>
						<p>因为没有分蛋器，我用的是勺子和叉子进行分离的。</p>
						<p class="tips">tips:鸡蛋可以在冷藏室冰一会，有利于分离。</p>
					</div>
					<div class="intro_img">
						<img src="img/gjdg/step_02.jpg">
					</div>
				</div>
			</section>
			<section class="step step03">
				...
				<div class="contentR">
					<div class="intro_word">
						<p>打匀蛋黄</p>
						<p>建议买一个打蛋器，没有的话要用叉子慢慢打了~</p>
					</div>
					<div class="intro_img">
						<img src="img/gjdg/step_03.jpg">
					</div>
				</div>
			</section>
			...
			<section class="step step05">
				...
				<div class="contentR">
					<div class="intro_word">
						<p>打泡</p>
						<p>把蛋清倒入无油无水的容器中打至起泡。</p>
						<p>在之中加入白砂糖。</p>
						<p>直至打到起泡后，倒入刚才的蛋黄液中，涂匀后放入电饭煲中开始烤。</p>
					</div>
					<div class="intro_img">
						<img src="img/gjdg/step_05.jpg">
					</div>
				</div>
			</section>
			<section class="step step06">
				...
				<div class="contentL">
					<div class="intro_word">
						<p>涂果酱</p>
						<p>待电饭煲烤好后，盛出涂上果酱即可~</p>
					</div>
					<div class="intro_img">
						<img src="img/gjdg/step_06.jpg">
					</div>
				</div>
			</section>
		</div>
...
var m_material = [{name:"鸡蛋",num:"五个"},{name:"低筋面粉",num:"120克"},{name:"牛奶",num:"40ml"},{name:"果酱",num:"若干"}];
var n_material = [{name:"白砂糖",num:"60克"},{name:"黄油",num:"30克"},{name:"无铝泡打粉",num:"1克"}];
