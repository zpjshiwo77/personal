...
<head>
	...
	<meta name="keywords" content="辣爽蓝调风情土豆泥">
	<meta name="description" content="辣爽蓝调风情土豆泥">
...
<body>
	...
	<div class="background">
		<div class='food'>
			<section class="main">
				<div class="intro">
					<img style="height:540px;width:720px;" src="img/tdn/main.png">
					<div class="title">
						<h1>辣爽蓝调风情土豆泥</h1>
						<h2 class="ff-youyuan">Hot Blues Mashed Potatoes</h2>
					</div>
				</div>
			...
			<section class="step step01">
				...
				<div class="contentR">
					<div class="intro_word">
						<p>准备食材。</p>
						<p>两个土豆水煮10-15分钟，猪肉剁成肉末，卷心菜剥下来洗干净后切成一节一节的，火腿肠切段。</p>
						<p class="tips">tips:土豆开始不用去皮，水煮完之后很容易剥皮。水煮后的土豆很烫，用冷水冷却两分钟之后再剥皮。</p>
					</div>
					<div class="intro_img">
						<img src="img/tdn/step_01.jpg">
					</div>
				</div>
			</section>
			<section class="show">
			...
			<section class="step step02">
				...
				<div class="contentL">
					<div class="intro_word">
						<p>做土豆泥</p>
						<p>把土豆去皮后放入盆中，用刀切块。</p>
						<p>用擀面杖或者其他钝器把土豆碾碎，碾成泥状。</p>
						<p class="tips">tips:土豆煮的越久，越容易碾成土豆泥。</p>
					</div>
					<div class="intro_img">
						<img src="img/tdn/step_02.jpg">
					</div>
				</div>
			</section>
			<section class="step step03">
				...
				<div class="contentR">
					<div class="intro_word">
						...
						<p>肉末炒熟。</p>
						<p>火腿肠煎炸至外表焦黄再出锅。</p>
						<p>卷心菜炒熟，待快熟的时候放入少许盐。</p>
					</div>
					<div class="intro_img">
						<img src="img/tdn/step_03.jpg">
					</div>
				</div>
			</section>
			<section class="step step04">
				...
				<div class="contentL">
					<div class="intro_word">
						<p>煎土豆泥</p>
						<p>在锅中放入土豆泥和炒熟的肉末。</p>
						<p>用小火煎土豆泥，直至出现焦黄的锅巴。</p>
						<p class="tips">tips:焦黄的锅巴很好吃，建议可以煎久一点。</p>
					</div>
					<div class="intro_img">
						<img src="img/tdn/step_04.jpg">
					</div>
				</div>
			</section>
			<section class="step step05">
				...
				<div class="contentR">
					<div class="intro_word">
						...
						<p>待土豆泥煎好以后，就可以出锅了~</p>
						<p>然后放入贵州辣椒面。</p>
						<p>最后在用香菜摆盘~漂亮的食物会更美味哦~</p>
						<p class="tips">tips:搭配一杯冰牛奶会更爽~（冰牛奶解辣哦~）</p>
					</div>
					<div class="intro_img">
						<img src="img/tdn/step_05.jpg">
					</div>
				</div>
			</section>
		</div>
